    ...
    render: function() {
        return (
            ...
            React.createElement(Navbar, null), 
                ...
                React.createElement("p", {className: "lead"}, React.createElement("small", null, "Search your favourites here.."))
            )
        );
    }
});
...
var InitialMovies=React.createClass({displayName: "InitialMovies",
  getInitialState: function() {
    var initial=[];
    $.ajax({
          url: "/movies",
      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "row"}, 
            this.state.data.map(function(d){
              return(
                React.createElement("div", {className: "col-lg-12 well"}, 
                React.createElement("div", {className: "col-lg-4"}, 
                React.createElement("img", {src: d.Poster, alt: "No Poster Available"})
                ), 
                React.createElement("div", {className: "col-lg-8"}, 
                 React.createElement("h4", null, d.Title), 
                 "Year: ", d.Year, 
                  React.createElement("p", {style: {marginTop:25}}, 
                  React.createElement("button", {className: "btn btn-primary", type: "submit", value: d.imdbID, onClick: self.removeMovie}, "Delete")
                  )
                )
                )
              )
              ...
              return (
                  React.createElement("div", {className: "col-lg-12 well"}, 
                   ...
                   React.createElement("div", {className: "col-lg-8"}, 
                    ...
                    "Year: ", d.Year, 
                     React.createElement("p", {style: {marginTop:25}}, 
                     React.createElement("button", {className: "btn btn-primary", type: "submit", value: d.imdbID, "data-target": "#add", "data-toggle": "modal", onClick: self.viewMovie}, "View Details")
                     )
                   )
                   )
                );
              }), 
              React.createElement("div", {className: "col-lg-12 modal", id: "add"}, 
                React.createElement("div", {className: "modal-dialog", style: {width:"90%"}}, 
                  React.createElement("div", {className: "modal-content"}, 
                    React.createElement("div", {className: "modal-header"}, 
                      React.createElement("button", {className: "close", "data-dismiss": "modal"}, "×"), 
                      React.createElement("h4", null, "Add Movie")
                    ), 
                    React.createElement("div", {className: "modal-body"}, 
                     React.createElement("div", {className: "row well", style: wellStyle}, 
                       React.createElement("div", {className: "col-lg-4"}, 
                         React.createElement("img", {src: view.Poster, alt: "No Poster Available"})
                       ), 
                       React.createElement("div", {className: "col-lg-8"}, 
                         React.createElement("h4", null, view.Title), 
                         "Year: ", view.Year, React.createElement("br", null), React.createElement("br", null), 
                         "Actors: ", view.Actors, React.createElement("br", null), React.createElement("br", null), 
                         "Director: ", view.Director, React.createElement("br", null), React.createElement("br", null), 
                         view.Plot, React.createElement("br", null), React.createElement("br", null), 
                         React.createElement("span", {className: "glyphicon glyphicon-calendar"}), view.Released, " |" + ' ' +
                         "Ratings:", React.createElement("input", {type: "hidden", id: "rating", className: "rating rating-loading", "data-min": "0", "data-max": "5"}), " |" + ' ' +
                         "Awards: ", view.Awards, 
                         React.createElement("p", {style: {marginTop:25}}, 
                         React.createElement("button", {className: "btn btn-primary", "data-dismiss": "modal", type: "submit", onClick: self.addToDB}, "Add To Database")
                         )
                       )
                     )
                    )
...
var SearchMovies=React.createClass({displayName: "SearchMovies",
  getInitialState: function() {
  return {data:[],name:''};
  },
  render:function(){
    ...
    React.createElement("div", {className: "container"}, 
    React.createElement("div", {className: "col-lg-4"}, 
    React.createElement("input", {className: "form-control", type: "text", id: "a", value: this.state.name, onChange: this.movieName})
    ), 
    React.createElement("div", {className: "col-lg-8", style: {marginBottom:20}}, 
    React.createElement("input", {className: "btn btn-info", type: "submit", value: "Search", onClick: this.searchOMDB})
    ), 
      React.createElement(SearchList, {movieList: this.state.data})
    )
    )
    );
  },
...
},{"./List":202,"./Navbar":204,"react":199}],206:[function(require,module,exports){
var React=require("react");
...
React.createElement(Route, {handler: Master}, 
  React.createElement(DefaultRoute, {handler: Navbar, name: "Home"})
), 
React.createElement(Route, {handler: HomePage, name: "HomePage", path: "/home"}), 
React.createElement(Route, {handler: OwnList, name: "ViewMovieBox", path: "/movies"}), 
React.createElement(Route, {handler: SearchAll, name: "MovieBox", path: "/add"})
)
);

},{"./components/Home":200,"./components/Initial":201,"./components/Master":203,"./components/Navbar":204,"./components/Search":205,"react":199,"react-router":35}]},{},[206]);
